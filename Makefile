...
SRC = minishell.c libft/ft_atoll.c libft/ft_putchar_fd.c libft/ft_putendl_fd.c libft/ft_putstr_fd.c libft/ft_split.c \
        ...
        libft/ft_strdup.c builtins/builtins_export_utils.c parsing/parsing_syn.c parsing/lexer_handel.c parsing/lexer_quotes.c parsing/free_parsing.c parsing/lexer_tools.c parsing/init_parsing.c parsing/lexer.c \
